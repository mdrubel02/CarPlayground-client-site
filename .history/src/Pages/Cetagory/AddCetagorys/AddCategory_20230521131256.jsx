...
const AddCategory = () => {
    const [formData,setFormData] = useState({
       ...
       const {name,price,rating,description,image} = formData
       useEffect(()=>{
         window.scrollTo(0, 0)
       },[])
                  ...
                  <form onSubmit={serviceAddHandle}>
                    <div className="mb-1 sm:mb-2">
                      <div className='relative  mb-3'>
                          <img src="https://i.ibb.co/rQM6h1C/gallery-10-removebg-preview.png" alt=""  className='absolute left-[-5px] top-0 text-black' />
                          <input
