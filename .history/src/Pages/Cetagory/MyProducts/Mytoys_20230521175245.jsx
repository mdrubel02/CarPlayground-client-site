                    ...
                    <tbody>
                        {/* row 1 */}
                        {
                            myToys.map((myToy, index) => <tr>
                                ...
                                <td>{myToy?.price}</td>
                                <th>
                                    <button className="inline-flex items-center justify-center w-full py-2 px-3 font-semibold tracking-wide text-white transition duration-200 rounded-full shadow-md outline-none bg-black">Edit</button>
                                </th>
                                <th>
