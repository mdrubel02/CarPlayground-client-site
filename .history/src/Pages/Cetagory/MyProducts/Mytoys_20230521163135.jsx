                        ...
                        {/* row 1 */}
                        {
                            myToys.map((myToy, index) => <tr>
                                ...
                                <td>
                                    ...
                                    <span className="badge badge-ghost badge-sm">{myToy?.description.slice(0, 15)}</span>
                                </td>
                                <td>{myToy?.quantity}</td>
                                <th>
                                    <button className="inline-flex items-center justify-center w-full py-4 px-6 font-semibold tracking-wide text-white transition duration-200 rounded-full shadow-md outline-none bg-black">Edit</button>
                                </th>
                                <th>
