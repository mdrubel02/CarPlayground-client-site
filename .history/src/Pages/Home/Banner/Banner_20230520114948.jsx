...
import bannerImg from '../../../assets/bannerCar.png'
          ...
          <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl w-full md:px-24 lg:px-8  lg:py-5">
            <div className="lg:grid w-full grid-cols-12 items-center justify-between xl:flex-row">
              <div className="w-full col-span-4 mb-12 xl:mb-0 text-white">
                ...
                Car<span className='text-yellow'>Playground</span>
              </span><br></br>
                <span className='text-yellow'>Shop</span>
                </h2>
                <p className="max-w-xl mb-4 text-base  md:text-lg">
                Homemade car is usually prepared with natural ingredients compared to commercially prepared food. Plainly, the food has its taste however those are ready using unprocessed foods that are by no means healthy.
                </p>
                <Link
                  to="/"
              ...
              src={bannerImg} alt="bannerImages" className='w-full'/>
              </div>
            </div>
          </div>
        </div>
